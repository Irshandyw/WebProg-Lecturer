...
@section('Title','Hospitalyn | Reservasi Dokter')

@section('Content')
<img src="img/DBanner.png" style="width:100%" alt="">
<h1 class="text-white text-center fs-3 p-2" style="background-color: #7BF295;text-shadow :1px 1px 2px grey">List of Our Doctors!</h1>

<div class="container" style="max-width: 75%">
    <form action="{{ route('searchdoctor') }}" method="GET">
        <div class="form-group">
            <label style="color: #7BF295; font-weight: bold">Cari Dokter yang Anda Butuhkan!</label>
            <input type="text" class="form-control" name="search" placeholder="Nama atau Spesialis Dokter!">
...
<div class="container" style="max-width: 75%" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-3" style="margin: 5px">
                        <div class="card-body">
                            ...
                            <a href="/delete/{{ $doctor->id }}" class="btn btn-outline-danger">Delete</a>
                        </div>
                    </div>
    ...
    <a href="/TambahDokter" class="btn btn-outline-success" style="">Tambah Dokter!</a>
    </div>
